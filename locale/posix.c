...
const struct __locale __libc_posix_locale = {
  ...
  .__LC_CTYPE = {
    {
      __libc_posix_iswalnum,
      __libc_posix_iswalpha,
      __libc_posix_iswblank,
      __libc_posix_iswcntrl,
      __libc_posix_iswdigit,
      __libc_posix_iswgraph,
      __libc_posix_iswlower,
      __libc_posix_iswprint,
      __libc_posix_iswpunct,
      __libc_posix_iswspace,
      __libc_posix_iswupper,
      __libc_posix_iswxdigit
    },
    {"tolower", "toupper"},
