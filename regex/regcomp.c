/* regcomp.c -- This file is part of OS/0 libc.
...
/* The REQUIRE macro seems to emit an unnecessary warning */
...
static void doinsert (register struct parse *p, sop op, size_t opnd,
		      sopno pos);
